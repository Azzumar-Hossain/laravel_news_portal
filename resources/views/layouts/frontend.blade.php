    ...
    <div class="container py-2 py-md-3 bg-white">
        <div class="row align-items-center">
            ...
            <div class="col-lg-3 col-md-2 d-none d-md-flex gap-3">
                <a href="#" class="text-dark fs-5 text-decoration-none hover-red"><i class="fa-solid fa-mobile-screen"></i></a>
                <a href="#" class="text-dark fs-5 text-decoration-none hover-red"><i class="fa-brands fa-facebook-f"></i></a>
    ...
    <footer class="bg-dark text-white pt-5 mt-5">
        ...
        <div class="py-3 text-center" style="background-color: #f3efe6; color: #111;">
            <span class="fw-medium" style="font-size: 0.95rem;">
                ...
                Developed by <a href="https://proyasit.com" target="_blank" class="text-decoration-none" style="color: #c44062; font-weight: 600;">Proyas IT</a>
            </span>
        </div>
    </footer>
